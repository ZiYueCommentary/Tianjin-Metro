...
public interface BlockList
{
    ...
    RegistryObject<Block> STATION_NAME_WALL_LEGACY = new RegistryObject<>(() -> new BlockStationNameWallLegacy(BlockBehaviour.Properties.copy(Blocks.STATION_NAME_WALL_WHITE.get())));
}
