...
public interface Filters
{
    ...
    Filter GATES = Filter.registerFilter(TianjinMetro.CREATIVE_MODE_TAB, Text.translatable("filter.tjmetro.gates"), () -> new ItemStack(BlockList.PSD_DOOR_TIANJIN.get()));
    ...
    Filter RAILWAY_SIGNS = Filter.registerFilter(TianjinMetro.CREATIVE_MODE_TAB, Text.translatable("filter.tjmetro.railway_signs"), () -> new ItemStack(BlockList.RAILWAY_SIGN_WALL_4.get()));
