    ...
    public void render(T entity, float tickDelta, GraphicsHolder graphicsHolder, int light, int overlay) {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            MainRenderer.scheduleRender(QueuedRenderLayer.TEXT, (newGraphicsHolder, offset) -> {
                ...
                IDrawingExtension.drawStringWithFont(newGraphicsHolder, getFormattedTime(entity.getWorld2().getTime()), HorizontalAlignment.CENTER, VerticalAlignment.CENTER, HorizontalAlignment.CENTER, 0, 0.05F, -1, -1, 30, -3276781, -3276781, 2, false, light, true, null);
