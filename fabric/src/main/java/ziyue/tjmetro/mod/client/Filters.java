...
public interface Filters
{
    ...
    static void init() {
        ...
        FilterBuilder.addBlocks(Filters.TIANJIN_SIGNS,
                ...
                STATION_NAME_ENTRANCE_TIANJIN, STATION_NAME_ENTRANCE_TIANJIN_PINYIN, STATION_NAME_ENTRANCE_TIANJIN_BMT, STATION_NAME_ENTRANCE_TIANJIN_BMT_PINYIN,
                STATION_NAME_WALL_LEGACY,
                STATION_NAME_PLATE);
