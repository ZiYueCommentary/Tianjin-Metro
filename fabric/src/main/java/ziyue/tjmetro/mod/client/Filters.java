...
public interface Filters
{
    ...
    static void init() {
        ...
        FilterBuilder.addBlocks(Filters.TIANJIN_DECORATION,
                ...
                LOGO, APG_CORNER, TIME_DISPLAY, TIME_DISPLAY_EVEN, EMERGENCY_EXIT_SIGN, SERVICE_CORRIDOR_SIGN, BENCH, METAL_DETECTION_DOOR, METAL_POLE_BMT, SECURITY_CHECK_SIGN,
